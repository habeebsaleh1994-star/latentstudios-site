// Release truth — the one file to edit as the products evolve.
// Every status chip, CTA label, and the community sections read from here;
// no other release truth may be hardcoded in page copy.
export const truth = {
  ritualStatus: 'Private beta',
  labStatus: 'Available for macOS',
